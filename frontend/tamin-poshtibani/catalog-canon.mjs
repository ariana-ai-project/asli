...
/* «آرماتور ← میلگرد» تصمیم مدیر است (مهر ۱۴۰۵)؛ بقیه از ممیزی دوم: غلط‌های املایی و تایپی، فاصله و
   پسوند («زانویی» ← «زانو»، «لولای» ← «لولا»)، نامِ به‌هم‌چسبیده («فیلترصافی» ← «فیلتر»)، و هم‌معنای
   عیناً همان کالا («تلمبه» ← «پمپ»، «رلیف ولوو» ← «فشار شکن»). فقط جفت‌هایی که واحد مرجعِ هر دو یکی
   است و قاعدهٔ جنسشان ناهمخوان نیست؛ «فوق روان کننده» (کالای دیگری جز روان‌کننده) عمداً نیامده. */
export const HEAD_ALIASES = {
  ...
  "پولکی": "پولک",
  "تابلوی": "تابلو",
  "اجرت تراش": "اجرت تراشکاری",
  "واشر و پیچ": "پیچ و واشر",
  "کیت سیت و گاید سوپاپ": "کیت سوپاپ و سیت و گاید",
  "اجرت تعویض و تراشکاری": "اجرت تراشکاری و تعویض",
  "کلیپ": "کلیپس",
  "کیت آبند": "کیت آبندی",
  "کیت آب": "کیت آبندی",
  "رینگ تایر": "رینگ چرخ",
  "اسپیدومترکاماز": "اسپیدومتر",
  "سرسیلندرموتورهوو": "سر سیلندر",
  "فیلترآبگیرلودر": "فیلتر",
  "فیلترصافی": "فیلتر",
  "رگلاتورکامل": "رگلاتور",
  "سوپرشارژکامل": "سوپر شارژ",
  "نمایشگرتوزین": "نمایشگر",
  "تایمرتاخیرویبره": "تایمر",
  "پرگارپلاستیکی": "پرگار",
  "انبرآرماتور": "انبر",
  "انکرهد": "انکر",
  "شارژکپسول": "شارژ",
  ...
  "نشان دهنده": "نشانگر",
  "سایلنسر": "خفه کن",
  "انبار اگزوز": "منبع اگزوز",
  "کارد": "چاقو",
  "ژیله": "جلیقه",
  "اسپیکر": "بلندگو",
  "ایزولاتور": "مقره",
  "موتور گیربکس": "الکتروگیربکس",
  "پتانسیومتر": "ولوم",
  "گاز دستی": "ولوم",
  "فاصله نگهدار": "فاصله انداز",
  "آبگردان": "ملاقه",
  "اتاق": "کابین",
  "لنت": "لنت ترمز",
  "میل گاردان": "گاردان",
...
/** نام‌های پایه‌ای که به این نام استاندارد می‌رسند (خودش نه) — به همان املای ذخیره‌شده، چون جستجوی SQL
    به بزرگی و کوچکیِ حروف حساس است («PLC»، «Alternator») */
export const aliasBases = (base) => { const k = keyOf(canonBase(base)); return Object.entries(HEAD_ALIASES).filter(([, b]) => keyOf(b) === k).map(([a]) => nameOf(a)); };
