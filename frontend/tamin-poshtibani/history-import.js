...
(function () {
  ...
  const COLUMNS = [
    ...
    /* «قیمت واحد» (ریال = مبلغ ÷ مقدار) اول: فایل تازهٔ سوابق هر دو ستون را دارد و «فی» آن‌جا به ارزِ
       سفارش است (مثلاً سامانی)؛ کلید یکتای ردیف (dkey) باید با فایل‌های قبلی یکی بماند */
    [["قیمت واحد", "فی"],       "unitPrice", false],
