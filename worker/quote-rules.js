 ...
 * نوع فاکتور پیش‌فرض «غیر رسمی» است. وقتی پیش‌فاکتوری خوانده شد و مدل نوعش را ننوشت،
 * «رسمی» می‌شود — مگر کارشناس خودش نوع فاکتور را انتخاب کرده باشد (quotes.invoice_src).
...
/* نوع فاکتور خط‌هایی که از خواندنِ پیش‌فاکتور پر می‌شوند، اگر خودِ سند چیزی نگفته باشد */
