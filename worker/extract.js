...
export const PROMPT_VERSION = "pf-extract/1.4";
...
شرحِ یک سطر، فقط خانهٔ «شرح کالا» نیست. در این فاکتورها مشخصه‌های فنی — اندازه، ضخامت، سایز، طول، گرید،
آلیاژ، استاندارد، برند، مدل، رنگ — معمولاً در ستون‌های جداگانه می‌نشینند و کنار نام کالا نوشته نمی‌شوند؛
گاهی هم در سرستونِ جدول یا در یادداشتی بالا یا پایین جدول آمده‌اند و به همهٔ سطرها مربوط‌اند.
پس پیش از هر تصمیمی دربارهٔ تطبیق، همهٔ خانه‌های آن سطر را با سرستون‌هایشان بخوان و کنار هم بگذار تا
شرح کاملِ کالا ساخته شود، بعد آن را با قلم درخواست بسنج. اگر تنها تفاوتِ ظاهری این است که مشخصه در
ستونی دیگر آمده، این تفاوت واقعی نیست و مانع تطبیق نمی‌شود؛ ولی اگر مشخصه‌ای واقعاً ناهم‌خوان است
(سایز یا گرید دیگر)، تطبیق نده. در description هم همان شرحِ کاملِ سرِهم‌شده را بنویس، نه فقط متن خانهٔ نام کالا.
